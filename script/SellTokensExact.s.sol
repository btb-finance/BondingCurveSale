...
contract SellTokensExactScript is Script {
    function run() external {
        ...
        console.log("Expected USDC return (raw):", usdcAfterFee);
        console.log("Target USDC return:", 499743000, "(from previous quote)");
        ...
        // Only proceed if the quote matches expected return
        require(usdcAfterFee >= 499743000 * 99 / 100, "USDC return too low"); // Allow 1% slippage
